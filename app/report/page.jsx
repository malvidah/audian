      ...
      <div style={{ position: "relative" }}>
        ...
        <div ref={expanded ? undefined : scrollRef} style={expanded ? {
          ...
          {mentions.map(m => {
            ...
            const gradientIdx  = Math.abs((m.name || "").split("").reduce((a, c) => a + c.charCodeAt(0), 0)) % AVATAR_GRADIENTS.length;
                ...
                {hasContent && (
                  <div style={{
                    ...
                    {(() => {
                      ...
                      return href ? (
                        <a href={href} target="_blank" rel="noreferrer" style={{ ...cs, textDecoration: "none", display: "block" }}>
                          {m.content}
                        </a>
